...
void printParaviewSnapshot() {
	...
	out << "<VTKFile type=\"PolyData\" >" << std::endl
		...
		<< "  <Points>" << std::endl
		<< "   <DataArray type=\"Float64\" NumberOfComponents=\"3\" format=\"ascii\">";//32
...
void updateBody() {
	...
	for (int k = 0; k < NumberOfBodies; k++) {
		...
		v[k][1] = v[k][1] + tPlotDelta * force[0] / mass[k];
		v[k][2] = v[k][2] + tPlotDelta * force[0] / mass[k];
		/*
